...
module.exports = {
    VERSION: 'v3.0.0',
    ALIVE: process.env.ALIVE || "https://i.imgur.com/lEzV0E9.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'V-F-C-F-C;ADEEN;0;https://i.imgur.com/lEzV0E9.jpeg;https://chat.whatsapp.com/ItdbRPBANdz0pDD47MTQlD',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "V-F-C-F-C_MD",
    BOT_NAME: process.env.BOT_NAME || 'V-F-C-F-C_MD',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'A-D-E-E-N;V-F-C-F-C MD bot;https://i.imgur.com/lEzV0E9.jpeg' : process.env.AUDIO_DATA,
